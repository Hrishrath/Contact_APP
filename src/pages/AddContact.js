...
const AddContact = () => {
  ...
  const imagePicker = async e => {
    ...
    try {
      ...
      const strorageRef = await firebase.storage().ref()

      var uploadTask = strorageRef.child('images/'+ file.name)
            ...
            <FormGroup check>
              <Label check>
                <Input
                  ...
                  checked={star}
                />{" "}
                <span className="text-right text-white">Mark as Star</span>
              </Label>
            </FormGroup>
            <Button
              type="submit"
